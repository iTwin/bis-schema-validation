...
import { SchemaComparison, ComparisonResultType, CompareOptions } from "./SchemaComparison";
...
function input(value: string, inputs: string[]) {
  inputs.push(value);
  return inputs;
}

const program = new commander.Command("schema-comparer");
